    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const dadosParaAPI = {
                ...
                ficha_tec: formData.ficha_tec && formData.ficha_tec.trim() !== '' ? formData.ficha_tec : null,
                link_prod: formData.link_prod && formData.link_prod.trim() !== '' ? formData.link_prod : null,
